...
#define CHALF 3 /* Size of the cross half. Size of the cross is CHALF*2 x CHALF*2.
		   */
#define CPITCH 36 /* Distance between cross centers */

/* XCROSSES A4 65, US Letter 67. WarrInt adjusts this for DPI 200. */
#define XCROSSES 14 /* Number of crosses horizontally */
/* YCROSSES A4 93, US Letter 87. WarrInt adjusts this for DPI 200. */
#define YCROSSES 17 /* Number of crosses vertically */
